...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/12/20 14:35:01 by atuomine          #+#    #+#             */
/*   Updated: 2020/01/08 10:52:00 by atuomine         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static char	*save_decimal(long double nb, long double whole, \
		int precision, int *i_pointer)
{
	int			i;
	long int	nb_int;
	char		*dec_part;
